                  ...
                  <div class="row">
                     <div class="col-xl-8 col-lg-7">
                        <div class="breadcrumb__content z-index-3">
                           <h3 class="breadcrumb__title tp-char-animation">Careers </h3>
                        </div>
                     </div>
                     ...
                     <div class="col-xl-7 col-lg-7">
                        <div class="career-details-wrapper">
                           ...
                           <div class="career-details-job-responsiblity mb-45">
                              ...
                              <p>Minimum 6 months of experience required. Freshers may also apply.</p>
                           </div>
                           <div class="career-details-job-responsiblity mb-45">
                              <h4 class="career-details-title-sm">
                                 We understand the needs</h4>
                              <p class="pb-15">We enhance your profitability while reducing the costs and risks
                                 associated with employment law compliance. Our suite of services includes payroll,
                                 employment taxes, health and benefits, retirement, human resources, employee manuals,
                                 safety, workers’ compensation, and more…</p>
                        ...
                        <div class="career-details-job-responsiblity mb-45">
                           <h4 class="career-details-title-sm">Employee Outreach</h4>
                           <p class="pb-15">Allow us to assist with subordinate documentation, fresh recruit onboarding,
                              proof of insurability prerequisites, qualifying occasion changes, inconsistency reports,
                              finance reviews, and the sky's the limit from there.</p>
                           <!-- <div class="career-details-job-list">
                              <ul>
                                 <li>
                                    <i class="fal fa-long-arrow-right"></i>
                        ...
                        <div class="career-details-job-responsiblity mb-20">
                           <h4 class="career-details-title-sm">
                              Open Position</h4>
                           <p class="pb-15">Join our mission to provide industry-leading digital marketing services to businesses around the globe - all while building your personal knowledge and growing as an individual.</p>
                           <!-- <div class="career-details-job-list">
                              <ul>
                                 <li>
                                    <i class="fal fa-long-arrow-right"></i>
                     ...
                     <div class="col-xl-5 col-lg-5 career-details-pin">
                           ...
                           <div class="career-details-apply-info-box">
                                 ...
                                 <form action="#" class="box">
                                    <div class="row gx-20">
                                       ...
                                       <div class="col-12">
                                          <div class="postbox__comment-input mb-30">
                                             <input type="text" class="inputText" required>
                                             <span class="floating-label">Personal website</span>
                                          </div>
                                       </div>
                                       <div class="col-12">
                                       ...
                                       <div class="col-12">
                                          <div class="postbox__comment-input mb-35">
                                             <input type="text" class="inputText" required>
                                             <span class="floating-label">Expected salary</span>
                                          </div>
                                       </div>
                                    </div>
                                 </form>
                              ...
                              <div class="col-xxl-12">
                                 <div class="postbox__resume-title-box">
                                    <h5 class="career-details-title-xs pb-15">Upload a recent resume or CV</h5>
                                 </div>
                                    ...
                                    <label for="cv">
                                       <span>
                                          <svg width="18" height="15" viewBox="0 0 18 15" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <path d="M11.9133 10.4519L9.00453 7.54309L6.0957 10.4519" stroke="#202124"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                             <path d="M9.00391 7.54309V14.0879" stroke="#202124" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                             <path
                                                ...
                                                stroke="#202124" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                             <path d="M11.9133 10.4519L9.00453 7.54309L6.0957 10.4519" stroke="#202124"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                          </svg>
                              ...
                              <div class="col-xxl-12">
                                 <div class="postbox__btn-box mb-50">
                                    <button class="submit-btn w-100">Submit Application</button>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-xxl-12">
                           ...
                           <div class="career-details-bottom-text text-center">
                              <a href="#">Employee at ASK Innovations?</a>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="col-12">
                        <div class="tp-cta-bg" data-background="assets/img/cta/cta-bg.jpg">
                           <div class="tp-cta-content tp-inner-font text-center">
                              ...
                              <a class="tp-btn-inner white-bg text-black" href="service-details.html">Get Started
                                 Now</a>
                           </div>
                        </div>
                     </div>
