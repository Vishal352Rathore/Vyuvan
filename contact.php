 ...
 <main>
            ...
            <div class="about-img-area mb-100 z-index-3">
               <div class="container">
                  <div class="row">
                     <div class="col-12">
                        <div class="about-img about-img-height p-relative" data-background="assets/img/contact.jpg">
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="contact-inner-title-sm-wrap text-center mb-50">
                           <h4 class="contact-inner-title-sm">Book a Vyuvan Infotech</h4>
                     ...
                     <div class="row gx-0">
                        ...
                        <div class="col-xl-4 col-lg-4">
                           <div class="contact-inner-item d-flex align-items-center justify-content-center">
                              ...
                              <div class="contact-inner-link">
                                 <a href="" target="_blank">Plot no 24-25 201/ 2d floor, platinum plaza PU-4 Scheme no 54, Vijay Nagar, Indore, Madhya Pradesh 452011</a>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-xl-7 col-lg-6">
                        <div class="contact-form-right-warp">
                           <div class="postbox__comment-form">
                              <form action="#" class="box" id="sendEmailForm">
                                 <div class="row gx-20">
                                    <div class="col-12">
                                       <div class="postbox__comment-input mb-30">
                                          <input type="text" class="inputText" name="name" id="name" required >
                                    ...
                                    <div class="col-12">
                                       <div class="postbox__comment-input mb-35">
                                          <input type="text" class="inputText" id="phone" required>
                                          <span class="floating-label">Phone Number</span>
                                       </div>
                                    </div>
                                    <div class="col-12">
                                       <div class="postbox__select mb-30" >
                                          <select id="inquiry_about">
                                             <option value="">Enquiry about</option>
                                             <option value="Web Design & Development">Web Design & Development</option>
                                             <option value="Mobile App Development">Mobile App Development</option>
                                             <option value="E-Commerse & CMS">E-Commerse & CMS</option>
                                    ...
                                    <div class="col-xxl-12">
                                       <div class="postbox__comment-input mb-30">
                                          <textarea class="textareaText" id="message" required></textarea>
                                    ...
                                    <div class="col-xxl-12">
                                       ...
                                       <div class="postbox__btn-box">
                                          <button class="submit-btn w-100" type="submit">Send your Request</button>
                                       </div>
