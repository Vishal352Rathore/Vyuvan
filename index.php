<?php include 'header.php';?>
         ...
         <main class="fix">
            ...
            <div class="tp-hero__area tp-hero__pl-pr" style="position: relative; overflow: hidden;">
               <div class="tp-hero__bg p-relative">
                  <img src="assets/img/banner.gif" alt="This is an animated gif image, but it does not move"/ style="position: absolute; top: 0px; left: 3%; width: 94%; height:800px; border-radius: 20px;">
                        ...
                        <div class="col-xl-10">
                           <div class="tp-hero__content-box text-center z-index-3">
                              <div class="tp-hero__title-box p-relative">
                                 <h2 class="tp-hero__hero-title tp-title-anim pt-4">
                                    Dream it. We'll create it. <br>Begin today!
                                 </h2>
                                 ...
                                 <div class="tp-hero__thumb-wrapper d-none d-md-block p-relative">
                                    <div class="row">
                                       <div class="tp-hero__thumb ">
                                          <img class="w-100" src="assets/img/preview.jpg" alt="">
                                       </div>
                                       <div class="col-8">
            ...
            <div class="tp-service__area p-relative fix">
               <div class="tp-service__grey-shape "></div>
               <div class="container">
                  <div class="row justify-content-center">
                     <div class="col-lg-8">
                        <div class="tp-service__section-box mb-50 text-center tp-title-anim">
                           <h2 class="tp-section-title ttd">Our Services</h2>
                           <p>We offer a comprehensive range of IT services designed to meet the diverse needs of our clients:</p>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/web-dev.png" alt="" width="60px;">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-theme-color"><a href="#">Website
                                    Development <br>
                                    &nbsp;</a></h3>
                              <p>Creating robust, scalable, and user-friendly websites.</p>
                           </div>
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".4s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/app-dev.png" alt="" width="60px">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-orange-color"><a href="#">App Development</a></h3>
                              <p>Developing innovative mobile applications for both Android and iOS platforms.</p>
                           </div>
                           <div class="tp-service__link">
                              <a href="#">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/tv-app.png" alt="" width="60px">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-purple-color"><a href="#">TV App Development*</a></h3>
                              <p>Crafting engaging applications for smart TVs</p>
                           </div>
                           <div class="tp-service__link">
                              <a href="#">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".8s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/shopify-app.png" alt="" width="60px">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-green-color"><a href="#">Shopify Solutions</a></h3>
                              <p>Providing customized Shopify solutions to enhance e-commerce experiences.</p>
                           </div>
                           <div class="tp-service__link">
                              <a href="erp-crm">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/ui-ux.png" alt="" width="60px">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-yellow-color"><a href="#">UI/UX Designing</a></h3>
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/figma.png" alt="" width="60px">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-yellow-color"><a href="#">Figma</a></h3>
                              <p>Utilizing Figma for collaborative interface design.</p>
                           </div>
                           <div class="tp-service__link">
                              <a href="italent">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/mobile-app.png" alt="" width="60px">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-yellow-color"><a href="#">Mobile Applications</a></h3>
                              <p>Developing high-performance mobile applications tailored to client needs.</p>
                           </div>
                           <div class="tp-service__link">
                              <a href="italent">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service__item mb-30">
                           <div class="tp-service__icon">
                              <img src="assets/img/dm.png" alt="" width="60px">
                           </div>
                           <div class="tp-service__content">
                              <h3 class="tp-service__title-sm tp-yellow-color"><a href="#">Digital Marketing</a></h3>
                              <p>Implementing effective digital marketing strategies to boost online presence.</p>
                           </div>
                           <div class="tp-service__link">
                              <a href="italent">
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                     ...
                     <div class="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                        <div class="tp-service__dashboard" data-background="assets/img/sv-bg.jpg">
                           <div class="tp-service__top-content">
                              <h3 class="tp-service__title-white">Outsourcing</h3>
                              <p>Offering reliable outsourcing solutions to optimize business processes.</p>
                              <a class="tp-btn-orange tp-btn-hover alt-color-white"
                                 href="hire-dev.php">
                                 <span>Explore</span>
                                 <b></b>
                              </a>
                           </div>
                           <div class="tp-service__dashdboard-sm-img yes">
                              <img class="wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s"
                                 src="assets/img/outcoursing.jpg" alt="">
                           </div>
                        </div>
                     </div>              
                  </div>
            ...
            <div class="sv-details-area tkg sv-details-space pt-100 ttd " style="display: none;">
               <div class="container">

                  <div class="row justify-content-center mobile com">
                     <div class="col-xl-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".2s">
                        <div class="tp-feature__section-box text-center mb-55 tp-title-anim">
                           <h2 class="tp-section-title "> Service Category</h2>
                           <p> Where our commitment to excellence and innovation sets us apart</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row   ">
                     ...
                     <div class="col-xl-5 col-lg-5">
                        <div class="sv-details-wid">
                           <div class="sv-details-category new-bg tab mb-30">
                              <div class="sv-details-category-title">
                                 <h4 class="sv-details-title-sm">Service Category</h4>
                              </div>
                              <div class="sv-details-category-list t">
                                 <ul>
                                    <li class="tablinks" onclick="openCity(event, 'Paris')">
                                       <a href="javascript:void(0)"><span>Mobile Application</span><i
                                             class="fal fa-angle-right"></i></a>
                                    </li>
                                    <li class=" tablinks" onclick="openCity(event, 'London')">
                                       <a href="javascript:void(0)"><span>Website design</span><i
                                             class="fal fa-angle-right"></i></a>
                                    </li>
                                    <li class="tablinks" onclick="openCity(event, 'Tokyo')" id="defaultOpen">
                                       <a href="javascript:void(0)"><span>Ecommerce</span><i
                                             class="fal fa-angle-right"></i></a>
                                    </li>
                                    <li class="tablinks" onclick="openCity(event, 'design')">
                                       <a href="javascript:void(0)"><span>UI / UX</span><i
                                             class="fal fa-angle-right"></i></a>
                                    </li>
                                    <li class="tablinks" onclick="openCity(event, 'erp')">
                                       <a href="javascript:void(0)"><span>ERP / CRM</span><i
                                             class="fal fa-angle-right"></i></a>
                                    </li>
                                 </ul>
                              </div>
                     ...
                     <div class="col-xl-7 col-lg-7">
                        <div id="London" class="tabcontent">
                           <div class="tp-price__item new-bg p-relative">

                              <div class="tp-price__feature new-tp row">
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/idea-bussiness-svgrepo-com.svg" alt="">
                                          </span>
                                          Business Website
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/website-2-svgrepo-com.svg" alt="">
                                          </span>
                                          Customized
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/news-svgrepo-com.svg" alt="">
                                          </span>
                                          News Website
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/blog-svgrepo-com.svg" alt="">
                                          </span>
                                          Blog Website
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/photo-svgrepo-com.svg" alt="">
                                          </span>
                                          Matrimonial Website
                                       </li>
                                 ...
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/website-svgrepo-com.svg" alt="">
                                          </span>
                                          Landing Pages
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/education-graduation-key-svgrepo-com.svg" alt="">
                                          </span>
                                          Educational
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/real-estate-house-key-svgrepo-com.svg" alt="">
                                          </span>
                                          Real Estate
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/money-transfer-svgrepo-com.svg" alt="">
                                          </span>
                                          financial Website
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/hospital-svgrepo-com.svg" alt="">
                                          </span>
                                          Hospital Website
                                       </li>
                              ...
                              <div class="tp-price__feature new-tp row">
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/ecommerce-online-shopping-app-svgrepo-com.svg" alt="">
                                          </span>
                                          Ecommerce Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/cut-scissors-svgrepo-com.svg" alt="">
                                          </span>
                                          Utility Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/lipstick-svgrepo-com.svg" alt="">
                                          </span>
                                          Lifestyle Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/entertainment-svgrepo-com.svg" alt="">
                                          </span>
                                          Entertainment Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/web-page-browser-window-svgrepo-com.svg" alt="">
                                          </span>
                                          Web Apps
                                       </li>
                                 ...
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/mobile-store-svgrepo-com.svg" alt="">
                                          </span>
                                          Native Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/mobile-svgrepo-com%20(1).svg" alt="">
                                          </span>
                                          Hybrid Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/game-machine-svgrepo-com.svg" alt="">
                                          </span>
                                          Gaming Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/love-svgrepo-com.svg" alt="">
                                          </span>
                                          Dating Apps
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/education-school-study-sticker-5-svgrepo-com.svg"
                                                alt="">
                                          </span>
                                          Education Apps
                                       </li>
                              ...
                              <div class="tp-price__feature new-tp row">
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/tie-dye-tshirt-svgrepo-com.svg" alt="">
                                          </span>
                                          Fashion
                                       </li>
                                       <li>
                                       ...
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/computer-tv-svgrepo-com.svg" alt="">
                                          </span>
                                          Electronics
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/books-svgrepo-com.svg" alt="">
                                          </span>
                                          Books
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/movie-ticket-svgrepo-com.svg" alt="">
                                          </span>
                                          Movie Tickets
                                       </li>
                                 ...
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/lego-svgrepo-com.svg" alt="">
                                          </span>
                                          Baby Products
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/groceries-svgrepo-com.svg" alt="">
                                          </span>
                                          Groceries
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/food-and-drink-svgrepo-com.svg" alt="">
                                          </span>
                                          Food / Delivery
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/furniture-time-svgrepo-com.svg" alt="">
                                          </span>
                                          Home Furnishings
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/necklace-svgrepo-com.svg" alt="">
                                          </span>
                                          Jewellery
                                       </li>
                              ...
                              <div class="tp-price__feature new-tp row">
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/tag-sale-label-svgrepo-com.svg" alt="">
                                          </span>
                                          Product Design
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/graphic-tool-ruler-svgrepo-com.svg" alt="">
                                          </span>
                                          Graphic Design
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/businessman-manager-svgrepo-com.svg" alt="">
                                          </span>
                                          Corporate Identity
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/brand-google-analytics-svgrepo-com.svg" alt="">
                                          </span>
                                          Brand Design
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/box-package-shipping-svgrepo-com.svg" alt="">
                                          </span>
                                          Packaging Design
                                       </li>
                                 ...
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img
                                                src="assets/img/apartment-building-construction-home-house-interior-svgrepo-com.svg"
                                                alt="">
                                          </span>
                                          Interior Design
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/skirt-svgrepo-com.svg" alt="">
                                          </span>
                                          Fashion Design
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/textile-printing-svgrepo-com.svg" alt="">
                                          </span>
                                          Textile Design
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/bedroom-svgrepo-com.svg" alt="">
                                          </span>
                                          Furniture Design
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/bedroom-stage-svgrepo-com.svg" alt="">
                                          </span>
                                          Exhibition Design
                                       </li>
                              ...
                              <div class="tp-price__feature new-tp row">
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/money-bag-finance-business-svgrepo-com.svg" alt="">
                                          </span>
                                          Finance
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/supermarket-svgrepo-com.svg" alt="">
                                          </span>
                                          Procurement
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/factory-svgrepo-com.svg" alt="">
                                          </span>
                                          Manufacturing
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/graph-svgrepo-com.svg" alt="">
                                          </span>
                                          Inventory Manage
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/online-order-shopping-ecommerce-svgrepo-com.svg"
                                                alt="">
                                          </span>
                                          Order Management
                                       </li>
                                 ...
                                 <div class="col-lg-6 col-sm-12">
                                    <ul>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/warehouse-storage-unit-storehouse-svgrepo-com.svg"
                                                alt="">
                                          </span>
                                          Warehouse Manage
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img
                                                src="assets/img/supply-chain-distribution-industry-production-svgrepo-com.svg"
                                                alt="">
                                          </span>
                                          Supply Chain Manage
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/customer-care-hospital-svgrepo-com.svg" alt="">
                                          </span>
                                          Customer Relationship
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/men-svgrepo-com.svg" alt="">
                                          </span>
                                          Workforce Manage
                                       </li>
                                       <li>
                                          <span class="iconss">
                                             <img src="assets/img/ecommerce-online-shopping-svgrepo-com.svg" alt="">
                                          </span>
                                          Ecommerce
                                       </li>
            ...
            <!-- tp-about-area-start -->
            <div class="tp-about__area tp-about__pt-pb pt-100 pb-120">
               <div class="container">
                  <div class="row align-items-center">
                     <div class="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".2s">
                        <div class="tp-about__img-wrapper text-center text-lg-end p-relative">
                           ...
                           <div class="tp-about__main-img xi z-index">
                     ...
                     <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".6s">
                        <div class="tp-about__right">
                           <div class="tp-about__section-box">
                              <h3 class="tp-section-title mb-15">About Vyuvan Infotech Pvt Ltd</h3>
                              <p style="text-align: justify;" >Vyuvan Infotech Pvt Ltd is a rapidly growing IT company that has made significant strides in the industry over the past two years. Our commitment to excellence and innovation has positioned us as a leading service provider, delivering exceptional solutions across various domains..</p>
                           </div>
                           <div class="tp-about__btn">
                              <a class="tp-btn tp-btn-hover alt-color-black" href="about.php">
                                 <span>About Us</span>
                                 <b></b>
                              </a>
                           </div>
            ...
            <div class="ab-brand-area">
               <div class="container">
                  <div class="ab-brand-border-bottom pb-90 mb-100">
                     <div class="row">
                        <div class="col-12">
                           <div class="ab-brand-section-box text-center mb-50">
                              <h3 class="tp-section-title">Our Projects and Products</h3>
                              <p>Our portfolio includes a diverse range of successful projects and products, such as</p>
                           </div>
                        </div>
                     </div>
                     <div class="row justify-content-center">
            ...
            <div class="tp-platform-area tp-platform-inner pt-10 pb-100 p-relative z-index">
               <div class="container">
                  <div class="row align-items-end mb-60">
                     <div class="col-xl-7 col-lg-6 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".3s">
                        <div class="tp-platform-section-box">
                           <h3 class="tp-section-title">How Do We Do It?</h3>
                        </div>
                     </div>
                  </div>
                  <!-- <div class="row justify-content-center">
                           ...
                           <div class="row-custom">
                              <div class="col-custom">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>01.</span>
                                       <h4 class="tp-panel-title child-one">Effective <br> Consulting</h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <a href="mobile-application">
                                          <h4 class="tp-panel-title-2">Effective <br> Consulting</h4>
                                       </a>
                                       <p>We believe clarity in communication is the key to a successful accomplishment. Thus, collecting and freezing requirements wisely is the first step.</p>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-custom">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>02.</span>
                                       <h4 class="tp-panel-title child-two">Exploring <br> The Best</h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <a href="web-development">
                                          <h4 class="tp-panel-title-2">Exploring <br> The Best</h4>
                                       </a>
                                       <p>Craft responsive, visually appealing websites with dynamic content and
                                          intuitive user interfaces.</p>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-custom ">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>03.</span>
                                       <h4 class="tp-panel-title child-three">Planning <br> The Steps</h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <a href="e-Commerce%20">
                                          <h4 class="tp-panel-title-2">Planning <br> The Steps</h4>
                                       </a>
                                       <p>We after internal discussions, select the relevant experienced developers & also allocate a technical project manager to ensure a smooth and efficient performance.</p>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-custom active">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>04.</span>
                                       <h4 class="tp-panel-title child-four">Designing & <br> Development</h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <a href="erp-crm">
                                          <h4 class="tp-panel-title-2">Designing & <br> Development</h4>
                                       </a>
                                       <p>ow, the steering goes in our expert designers and developer’s hands. Since they actually know how to blend the skills and experience to put something amazing on the table.</p>
                              ...
                              <div class="col-custom">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>05.</span>
                                       <h4 class="tp-panel-title child-four">Testing <br> & Analysis </h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <a href="ui-ux">
                                          <h4 class="tp-panel-title-2">Testing <br> & Analysis</h4>
                                       </a>
                                       <p>Since we’re committed to offer the best flawless and seamless solutions to our clients, thus we test our work in-house multiple times to ensure the website, web app or mobile app stays intact after going live!</p>
                                    </div>
                                 </div>
                              </div>
            ...
            <div class="tp-project__area grey-bg pt-50 pb-110 fix">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-6">
                        <div class="tp-project__section-box wow tpfadeLeft" data-wow-duration=".9s"
                           data-wow-delay=".3s">
                           <h3 class="tp-section-title">Testimonial...</h3>
                        </div>
                     </div>
                  </div>
               </div>
                                       ...
                                       <div class="tp-project__item d-flex align-items-center">
                                          <div class="tp-project__content">
                                             ...
                                             <div class="tp-project__title-box">
                                                <img src="assets/img/peter.png" alt="" width="80px;" class="mb-25">
                                                <p>Vyuvan Infotech user-friendly interface makes it easy for beginners and experienced developers alike to create stunning websites and apps without any hassle.
                                                </p>
                                             </div>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          <div class="tp-project__content">
                                             ...
                                             <br>
                                             <div class="tp-project__title-box">
                                                <img src="assets/img/shankar.png" alt="" width="80px;" class="mb-25">
                                                <p> The speed at which you can develop and deploy websites and apps using Vyuvan is impressive. 
                                                </p>
                                             </div>
                                             <div class="tp-project__meta d-flex align-items-center">
                                                <div class="tp-project__author-info">
                                                   <h4>Shankar Guruswamy - TMA</h4>
                                                </div>
                                             </div>
                                             <br>
                                             <br>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          <div class="tp-project__content">
                                             ...
                                             <br>
                                             <div class="tp-project__title-box">
                                                <img src="assets/img/steve.png" alt="" width="80px;" class="mb-25">
                                                <p>Vyuvan Infotech offers a wide range of versatile templates that are perfect for any type of project, saving a lot of design time.</p>
                                             </div>
                                             <div class="tp-project__meta d-flex align-items-center">
                                                <div class="tp-project__author-info">
                                                   <h4>Steve - Soaring Lab</h4>
                                                </div>
                                             </div>
                                             <br>
                                             <br>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          <div class="tp-project__content">
                                             ...
                                             <br>
                                             <div class="tp-project__title-box">
                                                <img src="assets/img/jeevaraj.png" alt="" width="80px;" class="mb-25">
                                                <p>The responsive design features ensure that our websites and apps look great on all devices, providing an optimal user experience.</p>
                                             </div>
                                             <div class="tp-project__meta d-flex align-items-center">
                                                <div class="tp-project__author-info">
                                                   <h4>Jeevaraj- Jplayer</h4>
                                                </div>
                                             </div>
                                             <br>
                                             <br>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          <div class="tp-project__content">
                                             ...
                                             <br>
                                             <div class="tp-project__title-box">
                                                <img src="assets/img/sitharaman.png" alt="" width="80px;" class="mb-25">
                                                <p>The platform supports a variety of integrations and plugins, allowing us to add advanced functionalities easily.</p>
                                             </div>
                                             <div class="tp-project__meta d-flex align-items-center">
                                                <div class="tp-project__author-info">
                                                   <h4>Sitharaman- TSR CNC</h4>
                                                </div>
                                             </div>
                                             <br>
                                             <br>
                                    ...
                                    <div class="tp-project__slider-wrapper">
                                       <div class="tp-project__item d-flex align-items-center">
                                          <div class="tp-project__content">
                                             ...
                                             <br>
                                             <div class="tp-project__title-box">
                                                <img src="assets/img/cheelim.png" alt="" width="80px;" class="mb-25">
                                                <p>We shared our vision for an interactive mobile app which seamlessly flows through cross platforms and quickly platforms dId it exactly that way. We’re more than happy and will refer Quickly Platforms to other businesses as well.</p>
                                             </div>
                                             <div class="tp-project__meta d-flex align-items-center">
                                                <div class="tp-project__author-info">
                                                   <h4>Chee Lim -Doubly Skincare</h4>
                                                </div>
                                             </div>
                                             <br>
                                             <br>
            ...
            <div class="tp-testimonial__area pt-105 pb-200 fix" style="display: none;">
               <div class="container">
                  <div class="row justify-content-center">
                     <div class="col-xl-6">
            ...
            <!-- tp-rank-area-start -->
            <div class="tp-rank__area pt-150 pb-200">
               <div class="container">
                  <div class="row">
                     <div class="col-xl-7 col-lg-7 order-1 order-lg-1" style="display: flex; align-items: center;">
                        <div>
                           <div class="tp-rank__section-box pb-25 wow tpfadeUp" data-wow-duration=".9s"
                           data-wow-delay=".3s">
                           <h4 class="tp-section-subtitle">We are a</h4>
                           <h3 class="tp-section-title">Tech Company
                           </h3>
                           <p>Vyuvan Infotech has worked with various businesses and organizations to provide instant
                              services and web solutions that enable clients to quickly reconfigure and develop new
                     ...
                     <div class="col-xl-5 col-lg-5 order-0 order-lg-2">
                        <img src="assets/img/tech-company.png">
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="row justify-content-center">
                     <div class="col-xl-7 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                        <div class="tp-price__section-box text-center mb-35">
                           <p>TECHNOLOGIES</p>
                           <h2 class="tp-section-title">What We Are Serving</h2>
         ...
         <div class=" tp-payment-method__area new-tap tp-payment-method__space" id="technologies" >
