         <footer class="pb-50">
            ...
            <div class="tp-footer__pl-pr p-relative">
               ...
               <div class="tp-footer__area pt-50">
                  <div class="container">
                     ...
                     <div class="tp-footer__top-space">
                        <div class="row">
                           <div class="col-xl-6 col-lg-6 col-md-7 pb-30 wow tpfadeUp" data-wow-duration=".9s"
                              data-wow-delay=".5s">
                              <div class="tp-footer__widget footer-col-1">
                                 <a href="index-2.html" class="tp-footer__widget-logo tt mb-10">
                                    <img src="assets/img/w-logo.png" alt="">
                                 </a>
                                 <div class="tp-footer__text">
                                    <p>Vyuvan Infotech is an established web development and design company that works
                                       with companies in all sectors of business. We combine the latest technologies,
                                       tools, and frameworks with years of experience to deliver customized, reliable,
                                 ...
                                 <div class="tp-footer__social">
                                    ...
                                    <a
                                       href="https://www.linkedin.com/in/ask-innovations-a62a111ba/?originalSubdomain=in"><i
                                          class="fab fa-linkedin-in"></i></a>
                                    <a href="https://www.instagram.com/askinnovations/"><i
                                 ...
                                 <div class="tp-footer__contact-info tp-footer__icon-space">
                                    <ul>
                                       <li>
                                          ...
                                          <a href="tel:+91 83589 13656">+91 83589 13656</a>
                                       </li>
                                       <li>
                                          <span>
                                          ...
                                          <a href="mailto:info@vyuvaninfotech.com">info@vyuvaninfotech.com</a>
                                       </li>
                                       <li>
                                          <span>
                                          ...
                                          <a href="#"
                                             target="_blank"> Plot no 24-25 201/ 2d floor, platinum plaza PU-4 Scheme no 54, Vijay Nagar, Indore, Madhya Pradesh 452011</a>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
               ...
               <div class="tp-copyright__area pt-20 pb-20">
                  <div class="container">
                     <div class="row align-items-center">
                        <div class="col-md-12 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                           <div class="tp-copyright__text text-center">
                              <span>Full Copyright & Design By <a href="#">Vyuvan Infotect</a> – 2024</span>
                           </div>
                        </div>
                     </div>
                  </div>
...
<!-- Mirrored from askinnovations.co.in/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jul 2024 05:39:10 GMT -->
</html>