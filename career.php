                  ...
                  <div class="row">
                     <div class="col-xl-8 col-lg-7">
                        <div class="breadcrumb__content z-index-3">
                           <h3 class="breadcrumb__title tp-char-animation text-dark">Careers </h3>
                        </div>
                     </div>
                           ...
                           <div class="job-post-wrapper d-flex align-items-center">
                              <div class="job-post-time d-flex align-items-center">
                                 <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    ...
                                    <path d="M9 5.7998V9.9998L11.8 11.3998" stroke="#5F6168" stroke-width="1.5"
                        ...
                        <div class="col-lg-3 col-md-3">
                           <div class="job-post-apply-btn text-start text-md-end">
                              <a class="tp-btn-inner tp-btn-hover alt-color-orange"
                                 href="career-details.php"><span class="" >Apply</span> <b></b></a>
                           </div>
                        </div>
                     </div>
                  </div>
